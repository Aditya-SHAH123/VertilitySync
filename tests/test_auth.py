...
os.environ.setdefault('STUDY_STORE_PATH', '/tmp/vitalitysync_test_auth_studies')
os.environ.setdefault('IMAGING_DATABASE_URL', 'sqlite:////tmp/vitalitysync_test_auth_imaging.db')
